                ...
                if (password != null) {
                    if (configuration.isImportHashedPassword()) {
                        password.access(new GuardedString.Accessor() {
                            ...
                            public void access(char[] clearChars) {
                                ...
                                switch (passwordHashAlgorithm) {
                                    case SHA_1:
                                        userBuilder.setSha1PasswordHash(new String(clearChars),
                                                configuration.getSalt(), configuration.getSaltOrder());
                                        break;
                                    case SHA_256:
                                        userBuilder.setSha256PasswordHash(new String(clearChars), null, null);
                                        break;
                                    case SHA_512:
                                        userBuilder.setSha512PasswordHash(new String(clearChars), null, null);
                                        break;
                                    case BCRYPT:
                                        userBuilder.setBcryptPasswordHash(new String(clearChars), null, 10);
                                        break;
                                    default:
                        ...
                        password.access(new GuardedString.Accessor() {
                            ...
                            public void access(char[] clearChars) {
                                userBuilder.setPassword(clearChars);
                            }
                        });
                    }
                }
    ...
    public Uid update(
        ...
        if (ObjectClass.ACCOUNT.equals(objectClass)) {
            ...
            try {
                GuardedString password = accessor.getPassword();
                if (password != null) {
                    final ExtensibleResource credentails = client.instantiate(ExtensibleResource.class);
                    try {
                        password.access(new GuardedString.Accessor() {
                            ...
                            public void access(char[] clearChars) {
                                ...
                                passwordCredentials.setValue(clearChars);
    ...
    public void test() {
        if (configuration != null) {
            if (client != null) {
                ...
                OktaUtils.handleGeneralError("Test error. Problems with client service");
            }
        } else {
