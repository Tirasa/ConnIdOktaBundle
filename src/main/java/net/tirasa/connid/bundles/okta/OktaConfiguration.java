...
public class OktaConfiguration extends AbstractConfiguration {
    ...
    @ConfigurationProperty(order = 3, displayMessageKey = "passwordHashAlgorithm.display",
            groupMessageKey = "basic.group", helpMessageKey = "passwordHashAlgorithm.help", required = true,
            confidential = false)
    ...
    @ConfigurationProperty(order = 4, displayMessageKey = "importHashedPassword.display",
            groupMessageKey = "basic.group", helpMessageKey = "importHashedPassword.help", required = true,
            confidential = false)
    ...
    @ConfigurationProperty(order = 5, displayMessageKey = "salt.display",
            groupMessageKey = "basic.group", helpMessageKey = "salt.help", required = true,
            confidential = true)
    ...
    @ConfigurationProperty(order = 6, displayMessageKey = "saltOrder.display",
            groupMessageKey = "basic.group", helpMessageKey = "saltOrder.help", required = true,
            confidential = false)
